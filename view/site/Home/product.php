 <!-- catg header banner section -->
  <section id="aa-catg-head-banner">
   <img src="public/site/img/banner_prd1.jpg" alt="fashion img">
   <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        <h2>Sản phẩm</h2>
        <ol class="breadcrumb">
          <li><a href="index.html?c=index&a=index">Trang chủ</a></li>         
              ...
              <nav>
                <ul class="pagination">
                  <?php
                                if($data['page'] > 1 ) {
                                    $prev = $data['page'] - 1;
                                    echo '<li class="page-item"><a class="page-link" href="index.php?c=product&a=product&page='.$prev.'">&laquo;</a></li>';
                                }
                            ?>

                            <?php
                                for($i = 1; $i <= $data['totalPage']; $i++){
                                    $link = "index.php?c=product&a=product&page=$i";
                                    if($i == $data['page']){
                            ...
                            <?php
                                if($data['page'] < $data['totalPage'] ) {
                                    $next = $data['page'] + 1;
                                    echo '<li class="page-item"><a class="page-link" href="index.php?c=product&a=product&page='.$next.'">&raquo;</a></li>';
                                }
                            ?>
                </ul>
              </nav>
